...
```{r render-agreement, eval = FALSE}
rmarkdown::render("contract/consulting-agreement.Rmd",
                  output_format = "wjake::consulting_agreement",
                  output_file = "_report/consulting-agreement.pdf",
                  params = list(
                    client = list(name = rmarkdown::metadata$recepient$name,
                                  company = rmarkdown::metadata$recepient$organization,
                                  address = rmarkdown::metadata$recepient$address2,
                                  city = rmarkdown::metadata$recepient$address3),
